...
enum {
    ...
    F_TRYCATCH, F_SPECIAL_APPLY, F_SETQ, F_PROG1, F_BEGIN, F_FOR,
    ...
    F_ADD, F_SUB, F_MUL, F_DIV, F_IDIV, F_LT, F_BNOT, F_COMPARE,

    F_VECTOR, F_AREF, F_ASET,
    F_TRUE, F_FALSE, F_NIL,
    N_BUILTINS,
};
#define isspecial(v) (uintval(v) <= (unsigned int)F_FOR)
