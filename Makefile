...
install: release
	mkdir -p /usr/local/share/flisp
	cp -f flisp /usr/local/share/flisp/
	cp -f flisp.boot /usr/local/share/flisp/
	ln -sf /usr/local/share/flisp/flisp /usr/local/bin/flisp
